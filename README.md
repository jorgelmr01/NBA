...
data/                 # bundled datasets (+ generated players/)
  ...
  team-seasons.js     # franchise -> season -> roster (generated, for role groups)
...
tools/generate-players.py        # downloads per-player season stats
tools/build-team-seasons.py      # builds data/team-seasons.js from those stats
```
